...
public class RatedMovie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -987947017037302115L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RatedMovie\",\"namespace\":\"com.kafka.handson\",\"fields\":[{\"name\":\"movie_id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"release_year\",\"type\":\"int\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public static com.kafka.handson.RatedMovie.Builder newBuilder() {
    return new com.kafka.handson.RatedMovie.Builder();
  }
   ...
   * @return A new RatedMovie RecordBuilder
   */
  public static com.kafka.handson.RatedMovie.Builder newBuilder(com.kafka.handson.RatedMovie.Builder other) {
    if (other == null) {
      return new com.kafka.handson.RatedMovie.Builder();
    } else {
      return new com.kafka.handson.RatedMovie.Builder(other);
    }
  }
   ...
   * @return A new RatedMovie RecordBuilder
   */
  public static com.kafka.handson.RatedMovie.Builder newBuilder(com.kafka.handson.RatedMovie other) {
    if (other == null) {
      return new com.kafka.handson.RatedMovie.Builder();
    } else {
      return new com.kafka.handson.RatedMovie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RatedMovie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.handson.RatedMovie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.handson.RatedMovie other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.movie_id)) {
        this.movie_id = data().deepCopy(fields()[0].schema(), other.movie_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder setMovieId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder clearMovieId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder setReleaseYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder clearReleaseYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.handson.RatedMovie.Builder clearRating() {
